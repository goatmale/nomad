...
func TestIsValidConfig(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			err: "reserved.reserved_ports 3-2147483647 invalid: port must be < 65536 but found 3-2147483647",
		},
		{
			...
			err: `host_network["test"].reserved_ports "3-2147483647" invalid: port must be < 65536 but found 3-2147483647`,
		},
	}
